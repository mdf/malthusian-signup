...
<p>Email: <?php echo $registrationSite->sessionEmail(); ?>
<p>
<p><br>
  tag: <img src="qrcache/?id=<?php echo $registrationSite->sessionTag(); ?>">
  
<p>This is your unique QR identity tag, you should bring it with you to all live events.
<p>
<p>
<p>
<p>
