...
define("E_VAL_MOBILE_CHECK_FAILED","Please provide a valid uk mobile phone number");
		  ...
		  case "mobile":
						{
							if(isset($input_value) && strlen($input_value)>0)
							{
								$bret= $this->validate_mobile($input_value);
								if(false == $bret)
								{
									$default_error_message = E_VAL_MOBILE_CHECK_FAILED;
								}
							}
							break;
						}
